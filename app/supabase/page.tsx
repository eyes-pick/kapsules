    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Alert className="border-yellow-500 bg-yellow-50">
        ...
        <AlertDescription className="text-yellow-700">
          A function with mutable search_path has been detected in your database. This poses a
          security risk.
        </AlertDescription>
      </Alert>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
              <li>
                Sets explicit{' '}
                <code className="bg-gray-100 px-1 rounded">search_path = &apos;&apos;</code> to
                prevent injection attacks
              </li>
              <li>
                Recreates the function with{' '}
                <code className="bg-gray-100 px-1 rounded">SECURITY DEFINER</code>
              </li>
          ...
          <Alert className="border-blue-200 bg-blue-50">
            <AlertDescription className="text-blue-700">
              ...
              <code className="bg-blue-100 px-2 py-1 rounded">supabase db push</code>
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
